...
if (
    IO_libraries_util.install_all_Python_packages(
        GUI_util.window, "narrative-analysis", ["os", "tkinter", "subprocess"]
    )
    == False
):
    sys.exit(0)
...
def run():
    ...
    if (
        ...
        and characters_NER_var == False
        and characters_WordNet_var == False
        and characters_DBpedia_YAGO_var == False
        and characters_byGender_var == False
        and characters_byGender_CoreNLP_var == False
        and characters_byGender_dict_var == False
        and characters_sentiment_arcs_var == False
        and characters_movement_var == False
        and dialogue_quotes_var == False
        and dialogue_coref_var == False
        and characters_semantic_space_var == False
        and time_NER_var == False
        and story_plot_var == False
        and space_NER_var == False
        and space_GIS_var == False
        and space_WordNet_var == False
        and space_DBpedia_YAGO_var == False
        and action_var == False
        and action_POS_var == False
        and action_WordNet_var == False
        and action_VerbNet_var == False
        and action_FrameNet_var == False
        and action_DBpedia_YAGO_var == False
        and SVO_var == False
        and shape_stories_var == False
        and story_parts_var == False
    ):
        mb.showwarning(
    ...
    if (
        characters_WordNet_var == True
        or space_WordNet_var == True
        or action_WordNet_var == True
        or action_VerbNet_var == True
        or action_FrameNet_var == True
    ):
    ...
    if (
        characters_DBpedia_YAGO_var == True
        or characters_DBpedia_YAGO_var == True
        or space_DBpedia_YAGO_var == True
        or action_DBpedia_YAGO_var == True
    ):
    ...
    if (
        characters_byGender_CoreNLP_var == True
        or characters_DBpedia_YAGO_var == True
        or characters_byGender_dict_var == True
    ):
...
extra_GUIs_checkbox = tk.Checkbutton(
    window,
    text="GUIs available for narrative analysis ",
    variable=extra_GUIs_var,
    onvalue=1,
    offvalue=0,
    command=lambda: activate_extra_GUIs(),
)
...
extra_GUIs_menu = tk.OptionMenu(
    window,
    extra_GUIs_menu_var,
    "Topic modeling (Open GUI)",
    "Style analysis (Open GUI)",
    "N-grams & Co-Occurrences (Open GUI)",
    "Sentiment analysis (Open GUI)",
    "Word2Vec/BERT embeddings (Open GUI)",
    "WordNet (Open GUI)",
    "Corpus Profiler (Open GUI)",
)
...
y_multiplier_integer = GUI_IO_util.placeWidget(
    window, GUI_IO_util.labels_x_coordinate, y_multiplier_integer, characters_lb, False, True
)
...
characters_WordNet_checkbox = tk.Checkbutton(
    window, text="Via WordNet", variable=characters_WordNet_var, onvalue=1, offvalue=0
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.narrative_analysis_2nd_column,
    y_multiplier_integer,
    characters_WordNet_checkbox,
    True,
    False,
    True,
    False,
...
characters_DBpedia_YAGO_checkbox = tk.Checkbutton(
    window, text="Via DBpedia/YAGO", variable=characters_DBpedia_YAGO_var, onvalue=1, offvalue=0
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.narrative_analysis_3rd_column,
    y_multiplier_integer,
    characters_DBpedia_YAGO_checkbox,
    True,
    False,
    True,
    False,
...
characters_byGender_CoreNLP_checkbox = tk.Checkbutton(
    window, text="By gender - Via CoreNLP", variable=characters_byGender_CoreNLP_var, onvalue=1, offvalue=0
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.narrative_analysis_4th_column,
    y_multiplier_integer,
    characters_byGender_CoreNLP_checkbox,
    True,
    False,
    True,
    False,
...
characters_byGender_dict_checkbox = tk.Checkbutton(
    window, text="By gender - Via dictionaries", variable=characters_byGender_dict_var, onvalue=1, offvalue=0
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.narrative_analysis_5th_column,
    y_multiplier_integer,
    characters_byGender_dict_checkbox,
    False,
    False,
    True,
    False,
...
dialogue_coref_checkbox = tk.Checkbutton(
    window,
    text="Who are all those he/she? Coreference resolution (CoreNLP)",
    variable=dialogue_coref_var,
    onvalue=1,
    offvalue=0,
)
y_multiplier_integer = GUI_IO_util.placeWidget(
...
characters_semantic_space_checkbox = tk.Checkbutton(
    window,
    text="Characters in their semantic space (BERT)",
    variable=characters_semantic_space_var,
    onvalue=1,
    offvalue=0,
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    ...
    GUI_IO_util.narrative_analysis_4th_column,
    y_multiplier_integer,
    characters_semantic_space_checkbox,
    False,
    False,
    True,
    False,
...
y_multiplier_integer = GUI_IO_util.placeWidget(
    window, GUI_IO_util.labels_x_coordinate, y_multiplier_integer, action_lb, False, True
)
...
action_FrameNet_checkbox = tk.Checkbutton(
    window, text="Via FrameNet", variable=action_FrameNet_var, onvalue=1, offvalue=0
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.narrative_analysis_4th_column,
    y_multiplier_integer,
    action_FrameNet_checkbox,
    True,
    False,
    True,
    False,
...
action_DBpedia_YAGO_checkbox = tk.Checkbutton(
    window, text="Via DBpedia/YAGO", variable=action_DBpedia_YAGO_var, onvalue=1, offvalue=0
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.narrative_analysis_5th_column,
    y_multiplier_integer,
    action_DBpedia_YAGO_checkbox,
    False,
    False,
    True,
    False,
...
character_action_lb = tk.Label(
    window, text="Characters in action: Who does/says What", foreground="red", font=("Courier", 12, "bold")
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window, GUI_IO_util.labels_x_coordinate, y_multiplier_integer, character_action_lb, False, True
)
...
dialogue_quotes_checkbox = tk.Checkbutton(
    window, text="Dialogues (CoreNLP)", variable=dialogue_quotes_var, onvalue=1, offvalue=0
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.narrative_analysis_2nd_column,
    y_multiplier_integer,
    dialogue_quotes_checkbox,
    True,
    False,
    True,
    False,
...
story_parts_checkbox = tk.Checkbutton(
    window, text="Narrative elements", variable=story_parts_var, onvalue=1, offvalue=0
)
...
y_multiplier_integer = GUI_IO_util.placeWidget(
    window, GUI_IO_util.labels_x_coordinate, y_multiplier_integer, scene_lb, False, True
)
...
story_plot_checkbox = tk.Checkbutton(
    window, text="Story & plot (CoreNLP)", variable=story_plot_var, onvalue=1, offvalue=0
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.narrative_analysis_2nd_column,
...
space_DBpedia_YAGO_checkbox = tk.Checkbutton(
    window, text="DBpedia/YAGO", variable=space_DBpedia_YAGO_var, onvalue=1, offvalue=0
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.labels_x_indented_coordinate,
    y_multiplier_integer,
    space_DBpedia_YAGO_checkbox,
    True,
    False,
    True,
    False,
...
characters_movement_checkbox = tk.Checkbutton(
    window, text="MAP characters moving in time and space", variable=characters_movement_var, onvalue=1, offvalue=0
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.narrative_analysis_2nd_column,
...
emotions_lb = tk.Label(
    window, text="Characters & emotions: How they feel", foreground="red", font=("Courier", 12, "bold")
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window, GUI_IO_util.labels_x_coordinate, y_multiplier_integer, emotions_lb, False, True
)

characters_sentiment_arcs_var.set(0)
characters_sentiment_arcs_checkbox = tk.Checkbutton(
    window,
    text="Sentiment arcs by character (Stanza NER + NRC)",
    variable=characters_sentiment_arcs_var,
    onvalue=1,
    offvalue=0,
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    ...
    GUI_IO_util.labels_x_indented_coordinate,
    y_multiplier_integer,
    characters_sentiment_arcs_checkbox,
    True,
    False,
    True,
    False,
...
shape_stories_checkbox = tk.Checkbutton(
    window, text="Shape of stories", variable=shape_stories_var, onvalue=1, offvalue=0
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.narrative_analysis_3rd_column,
    y_multiplier_integer,
    shape_stories_checkbox,
    False,
    False,
    True,
    False,
...
TIPS_lookup = {
    "Narrative analysis": "TIPS_NLP_Things to do with words Narrative analysis.pdf",
    ...
    "DBpedia": "TIPS_NLP_Annotator DBpedia.pdf",
    "YAGO": "TIPS_NLP_YAGO.pdf",
...
TIPS_options = (
    "Narrative analysis",
    "Stanford CoreNLP date extractor (NER normalized date)",
    "WordNet",
    "Annotator",
    "DBpedia",
    "DBpedia ontology classes",
    "YAGO",
    "YAGO (schema.org) ontology classes",
    "Gender annotator",
    "Annotator (via dictionary)",
    "SVO (Subject-Verb-Object extractor)",
    "Shape of stories",
...
def help_buttons(window, help_button_x_coordinate, y_multiplier_integer):
    ...
    y_multiplier_integer = GUI_IO_util.place_help_button(
        ...
        y_multiplier_integer,
        "NLP Suite Help",
        "Please, tick the 'GUIs available' checkbox to see and select other available tools suitable for narrative analysis (e.g., topic modeling, style analysis, sentiment analysis). The selected GUI will open without having to press RUN.",
    )
    ...
    y_multiplier_integer = GUI_IO_util.place_help_button(
        ...
        y_multiplier_integer,
        "NLP Suite Help",
        "Please, tick any of the checkboxes to extract the story characters using different NLP tools.",
    )
    ...
    y_multiplier_integer = GUI_IO_util.place_help_button(
        ...
        y_multiplier_integer,
        "NLP Suite Help",
        "Please, tick the checkbox to resolve coreferences: who do all those 'he', 'she', 'they' refer to? (via CoreNLP). Or tick 'Characters in their semantic space' to explore how close characters are to other words (actions, places, concepts) using BERT embeddings.",
    )
    ...
    y_multiplier_integer = GUI_IO_util.place_help_button(
        ...
        y_multiplier_integer,
        "NLP Suite Help",
        "Please, tick the checkboxes to extract SVO triplets (Subject-Verb-Object), dialogue (who says what, via CoreNLP quote annotator), or narrative elements.",
    )
    ...
    y_multiplier_integer = GUI_IO_util.place_help_button(
        ...
        y_multiplier_integer,
        "NLP Suite Help",
        "Please, tick the checkboxes to analyze the TEMPORAL and/or SPATIAL dimensions of stories via NER, CoreNLP, GIS, WordNet, and/or DBpedia/YAGO.",
    )
    ...
    y_multiplier_integer = GUI_IO_util.place_help_button(
        ...
        y_multiplier_integer,
        "NLP Suite Help",
        "Please, tick the checkboxes to analyze space via DBpedia/YAGO or to track how characters move across geographic locations over time (entity-location co-occurrence via Stanza NER).",
    )
    ...
    y_multiplier_integer = GUI_IO_util.place_help_button(
        ...
        y_multiplier_integer,
        "NLP Suite Help",
        "Please, tick the checkboxes to analyze characters' emotional trajectories: sentiment arcs by character (via Stanza NER + NRC) or the overall shape of stories.",
    )
    y_multiplier_integer = GUI_IO_util.place_help_button(
...
reminders_util.checkReminder(
    scriptName, reminders_util.title_options_narrative_analysis_ALL, reminders_util.message_narrative_analysis_ALL, True
)
