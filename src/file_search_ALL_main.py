...
open_CoNLL_search_GUI_button = tk.Button(
    window,
    text="CoNLL table searches (Open GUI)",
...
open_file_search_GUI_button = tk.Button(
    window,
    text="File searches (Open GUI)",
    width=GUI_IO_util.widget_width_medium,
    command=lambda: run_script_util.run_script("file_manager_main.py"),
)
# place widget with hover-over info
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
...
open_nGram_VIEWER_search_GUI_button = tk.Button(
    window,
    text="N-grams/co-occurrences searches (Open GUI)",
    width=GUI_IO_util.widget_width_medium,
    command=lambda: run_script_util.run_script("NGrams_CoOccurrences_main.py"),
)
# place widget with hover-over info
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
...
open_word_sense_search_GUI_button = tk.Button(
    window,
    text="Search word(s) for different word senses (Open GUI)",
    width=GUI_IO_util.widget_width_medium,
...
open_word_distance_search_GUI_button = tk.Button(
    window,
    text="Search word(s) for distance to other words in the semantic space (Open GUI)",
    width=GUI_IO_util.widget_width_medium,
    command=lambda: run_script_util.run_script("word2vec_main.py"),
)
# place widget with hover-over info
...
open_WordNet_search_GUI_button = tk.Button(
    window,
    text="WordNet searches (Open GUI)",
    width=GUI_IO_util.widget_width_medium,
...
open_word_search_GUI_button = tk.Button(
    window,
    text="Words/collocations searches (Open GUI)",
    width=GUI_IO_util.widget_width_medium,
...
export_csv_field_GUI_button = tk.Button(
    window,
    text="Export csv field content to csv/txt file (Open GUI)",
    width=GUI_IO_util.widget_width_medium,
    command=lambda: run_script_util.run_script("data_manipulation_main.py"),
)
# place widget with hover-over info
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
...
def help_buttons(window, help_button_x_coordinate, y_multiplier_integer):
    ...
    y_multiplier_integer = GUI_IO_util.place_help_button(
        ...
        y_multiplier_integer,
        "NLP Suite Help",
        "Please, click on the button to open the GUI for searching (and manipulating) files saved in your machine.",
    )
    y_multiplier_integer = GUI_IO_util.place_help_button(
        window,
        help_button_x_coordinate,
    ...
    y_multiplier_integer = GUI_IO_util.place_help_button(
        ...
        y_multiplier_integer,
        "NLP Suite Help",
        "Please, click on the button to open the GUI to run the word sense induction algorithm. The BERT algorithm will compute all the different meanings a word has in your corpus.",
    )
    y_multiplier_integer = GUI_IO_util.place_help_button(
        window,
        help_button_x_coordinate,
    ...
    y_multiplier_integer = GUI_IO_util.place_help_button(
        ...
        y_multiplier_integer,
        "NLP Suite Help",
        "Please, click on the button to open the GUI for searching words in the WordNet knowledge graph.",
    )
    y_multiplier_integer = GUI_IO_util.place_help_button(
        window,
        help_button_x_coordinate,
