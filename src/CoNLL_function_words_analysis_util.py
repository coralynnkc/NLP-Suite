...
if (
    IO_libraries_util.install_all_Python_packages(
        GUI_util.window, "function_words_analysis_main", ["csv", "os", "collections", "tkinter", "ntpath"]
    )
    == False
):
    sys.exit(0)
...
def pronoun_stats(
    ...
    function_words_stats_file_name = IO_files_util.generate_output_file_name(
    ...
    if 0:
        ...
        IO_csv_util.df_to_csv(
            GUI_util.window, df, pronouns_list_file_name, headers=headers, index=False, language_encoding="utf-8"
        )
        ...
        if chartPackage != "No charts":
            ...
            outputFiles = charts_util.plot(
                ...
                title="Frequency Distribution of Pronouns",
                x_label="Pronoun",
                count=count_var,
                file_label="FW_pron",
            )
            ...
            outputFiles = charts_util.plot(
                ...
                outputDir,
                columns=columns_to_be_plotted_yAxis,
                title="Frequency Distribution of Types of Pronouns",
                x_label="Pronoun type",
                count=count_var,
                file_label="FW_pron_type",
            )
    ...
    if 0:
        ...
        if chartPackage != "No charts":
            ...
            outputFiles = charts_util.plot(
                ...
                outputDir,
                columns=columns_to_be_plotted_yAxis,
                title="Frequency Distribution of Prepositions",
                x_label="Preposition",
                count=count_var,
                file_label="FW_prep",
            )
    ...
    if 0:
        ...
        if chartPackage != "No charts":
            ...
            outputFiles = charts_util.plot(
                ...
                outputDir,
                columns=columns_to_be_plotted_yAxis,
                title="Frequency Distribution of Articles",
                x_label="Article",
                count=count_var,
                file_label="FW_art",
            )
    ...
    if 0:
        ...
        if chartPackage != "No charts":
            ...
            outputFiles = charts_util.plot(
                ...
                outputDir,
                columns=columns_to_be_plotted_yAxis,
                title="Frequency Distribution of Conjunctions",
                x_label="Conjunction",
                count=count_var,
                file_label="FW_conj",
            )
            ...
            outputFiles = charts_util.plot(
                ...
                outputDir,
                columns=columns_to_be_plotted_yAxis,
                title="Frequency Distribution of Conjunction Words",
                x_label="Conjunction word",
                count=count_var,
                file_label="FW_conj_words",
            )
            if outputFiles != None:
                if isinstance(outputFiles, str):
                    filesToOpen.append(outputFiles)
    ...
    if 0:
        ...
        if chartPackage != "No charts":
            ...
            outputFiles = charts_util.plot(
                ...
                outputDir,
                columns=columns_to_be_plotted_yAxis,
                title="Frequency Distribution of Auxiliaries",
                x_label="Auxiliary verb",
                count=count_var,
                file_label="FW_aux",
            )
            if outputFiles != None:
...
def function_words_stats(
    ...
    startTime = IO_user_interface_util.timed_alert(
        GUI_util.window, 2000, "Analysis start", "Started running FUNCTION WORDS ANALYSES at", True, "", True, "", True
    )
