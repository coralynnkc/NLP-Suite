...
def run():
    ...
    if (
        utf8_var == False
        and ASCII_var == False
        and language_detect_var.get() == False
        and spelling_var.get() == False
        and NLTK_unusual_var.get() == False
        and lower_case_words_after_end_of_sentence_var.get() == False
        and word_length_var.get() == False
        and sentence_length_var.get() == False
    ):
        mb.showwarning(
