...
knowledge_graphs_DBpedia_YAGO_button = GUI_theme_util.create_button(window, width=GUI_IO_util.widget_width_long, text='HTML annotate corpus using the DBpedia & YAGO knowledge graphs (Open GUI)', command=lambda: run_script_util.run_script("knowledge_graphs_DBpedia_YAGO_main.py"))
