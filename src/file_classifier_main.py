...
def run():
    ...
    startTime = IO_user_interface_util.timed_alert(
        GUI_util.window, 2000, "Analysis start", "Started running the File Classifier at", True, "", True, "", True
    )
...
TIPS_lookup = {
    "Classify files (By date)": "TIPS_NLP_File classifier (By date).pdf",
    "Classify files (By NER)": "TIPS_NLP_File classifier (By NER).pdf",
