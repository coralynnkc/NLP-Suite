...
if (
    IO_libraries_util.install_all_Python_packages(
        GUI_util.window, "DB_PCACE_data_validation_main.py", ["os", "tkinter", "pandas"]
    )
    == False
):
    sys.exit(0)
...
y_multiplier_integer = GUI_IO_util.placeWidget(
    window, GUI_IO_util.entry_box_x_coordinate, y_multiplier_integer, csv_file_entry, True
)
...
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.IO_configuration_menu + GUI_IO_util.open_file_button_brief + 60,
    y_multiplier_integer,
...
y_multiplier_integer = GUI_IO_util.placeWidget(
    window, GUI_IO_util.labels_x_coordinate, y_multiplier_integer, spell_check_lb, True
)
...
y_multiplier_integer = GUI_IO_util.placeWidget(
    window, GUI_IO_util.labels_x_coordinate, y_multiplier_integer, lemmatize_lb, True
)
...
lemmatize_lang_menu = ttk.Combobox(
    window, textvariable=lemmatize_lang_var, width=20, values=_stanza_languages, state="disabled"
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.open_TIPS_x_coordinate + 200,
...
y_multiplier_integer = GUI_IO_util.placeWidget(
    window, GUI_IO_util.labels_x_indented_coordinate, y_multiplier_integer, lemmatize_nouns_lb, True
)
...
def _update_noun_hover():
    ...
    lemmatize_nouns_menu.bind(
        ...
        lambda e, t=combo_tip: GUI_IO_util.display_widget_info(
            window, e, GUI_IO_util.open_TIPS_x_coordinate, y_pos - 20, GUI_IO_util.open_TIPS_x_coordinate, t
        ),
    )
...
add_noun_button = tk.Button(
    window, text="+", width=GUI_IO_util.add_button_width, height=1, state="disabled", command=_add_noun_simplex
)
...
y_multiplier_integer = GUI_IO_util.placeWidget(
    window, GUI_IO_util.open_TIPS_x_coordinate + 380, y_multiplier_integer, lemmatize_verbs_lb, True
)
...
def _update_verb_hover():
    ...
    lemmatize_verbs_menu.bind(
        "<Enter>",
        lambda e, t=combo_tip: GUI_IO_util.display_widget_info(
            window, e, GUI_IO_util.open_TIPS_x_coordinate + 470, y_pos - 20, GUI_IO_util.open_TIPS_x_coordinate + 470, t
        ),
    )
...
add_verb_button = tk.Button(
    window, text="+", width=GUI_IO_util.add_button_width, height=1, state="disabled", command=_add_verb_simplex
)
...
y_multiplier_integer = GUI_IO_util.placeWidget(
    window, GUI_IO_util.labels_x_coordinate, y_multiplier_integer, agg_lb, True
)
...
agg_simplex_selected_label = tk.Entry(
    window, textvariable=agg_simplex_selected_var, width=_entry_width, state="readonly"
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.labels_x_indented_coordinate,
...
readMe_message = (
    "This GUI provides tools for validating and cleaning PC-ACE data.\n\n"
