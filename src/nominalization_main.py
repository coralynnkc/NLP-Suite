...
def run():
    ...
    outputFiles = nominalization_util.nominalization(
        inputFilename,
        inputDir,
        outputDir,
        config_filename,
...
y_multiplier_integer = GUI_IO_util.placeWidget(
    ...
    y_multiplier_integer,
    check_nom_verb_ending_checkbox,
    False,
    False,
    False,
    False,
