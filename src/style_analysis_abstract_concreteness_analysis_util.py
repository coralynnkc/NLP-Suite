...
def main(
    ...
    startTime = IO_user_interface_util.timed_alert(
        GUI_util.window, 2000, "Analysis start", "Started running CONCRETENESS Analysis at", True, silent=True
    )
    ...
    outputFiles = charts_util.plot(
        outputFilename,
        outputDir,
        columns=["Concreteness (Mean score)"],
        title="Frequency Distribution of Abstract/Concrete Scores",
        x_label="Concreteness scores",
        plot_list=["Concreteness (Mean score)"],
        title_label="Concreteness Statistics",
    )
    if outputFiles != None:
    ...
    IO_user_interface_util.timed_alert(
        ...
        2000,
        "Analysis end",
        "Finished running CONCRETENESS Analysis at",
        True,
        "",
        True,
        startTime,
