...
def checkTIPSDir(menu_lb):
    ...
    if not os.path.isdir(GUI_IO_util.TIPSPath):
        mb.showinfo(
            title="TIPS Warning",
            message="The script could not find a TIPS subdirectory. TIPS should be stored in a subdirectory called TIPS where your python script is stored.",
        )
